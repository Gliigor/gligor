    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/60 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          ...
          {/* NEW: Lead Automation — subtly emphasized, consistent with the nav */}
          <a
            href="/#/lead-automation"
            className="text-primary border border-primary/40 rounded-md px-3 py-1.5 hover:bg-primary/10 hover:border-primary/70 transition-all text-xs tracking-[0.15em] uppercase"
          >
            Lead Automation
          </a>
        </nav>
